...
<div class="wizard-steps">
  <div class="steps-wrapper">
    <div class="step completed">
      ...
      <span class="step-name">Vêtements 24h</span>
    </div>
    <div class="step completed">
      <span class="step-number"></span>
      <span class="step-name">Couvertures et couettes : 48h</span>
    </div>
    <div class="step completed">
      <span class="step-number"></span>
      <span class="step-name">Tapis : 72h</span>
    </div>

  </div>
    <div class="line"></div></div>
    <div class="imgcinter"><img src="assets/img/sintre.png"></div>
