            ...
            <tr class="product">
                <th><div class="product-card">
                        ...
                        <div class="product-tumb">
                            <img src="assets/img/produit/maison/canape.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">  Canapé </span>
                            <h4><a href="#"></a></h4>
                            <p id="title">Lavage pro </p>
                            <p>Sur place</p>
                            <div class="product-bottom-details">
                                <div class="product-price"><div class="prixvente">Prix sur devis </div></div>
                            </div>
                        </div>
                    </div></th>
                <!--card 2 -->
                <th><div class="product-card">
                        <div class="badg">Maison</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/maison/matelas.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Matelas   </span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage pro </p>
                            <p>Sur place</p>          
                            <div class="product-bottom-details">
                    ...
                    </div><th> <div class="product-card">
		
                       
                
      <a target="_blank" href="tel:+212619399999">

 <h4 style="font-weight:bold;font-size:20px; text-align: center; padding-bottom: 10px; color: black; background-color: #86B43E;border-radius: 80px;padding-top: 15px;padding-bottom: 15px;">Appelez 0619 399 999</h4>
</a>
