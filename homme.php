  ...
  gtag('config', 'UA-203843026-1');
    ...
    <body>
        ...
        <table>
            ...
            <tr class="product">
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/ChemisecintreeH.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory"> Chemise sur cintre H </span>
                            <h4><a href="#"></a></h4>
                ...
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/ChemiseplieeH.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Chemise pliée H </span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage et repassage (À sec)</p>
                            <p>Délai de livraison: 24h-48h</p>			
                            <div class="product-bottom-details">
                ...
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/Costume(2P)H.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Costume (2P) H</span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage et repassage (À sec)</p>
                            <p>Délai de livraison: 24h-48h</p>
                            <div class="product-bottom-details">
                                <div class="product-price"><div class="prixvente">50 DH</div></div>
            ...
            <tr class="product">
                <th><div class="product-card">
                        ...
                        <div class="product-tumb1">
                            <img src="assets/img/produit/homme/BasketsH.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Baskets H</span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage </p>
                            <p>Délai de livraison: 24h-48h</p>
                            <div class="product-bottom-details">
                ...
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/h/Jabadour(2P)H.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Jabadour (2P) H</span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage et repassage (À sec)</p>
                            <p>Délai de livraison: 24h-48h</p>
                            <div class="product-bottom-details">
                    ...
                    <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/JeanH.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Jean H</span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage et repassage (À sec)</p>
                            <p>Délai de livraison: 24h-48h</p>
                            <div class="product-bottom-details">
        ...
        <table>
            ...
            <tr class="product">
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/h/djellaba.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Jellaba Simple H</span>
                            <h4><a href="#"></a></h4>
                            <p id="title">Lavage et repassage (À sec)</p>
                            <p>Délai de livraison: 24h-48h</p>
                            <div class="product-bottom-details">
                ...
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/PantalonH.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Pantalon H</span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage et repassage (À sec)</p>
                            <p>Délai de livraison: 24h-48h</p>			
                            <div class="product-bottom-details">
                ...
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/h/PoloH.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory">Polo H</span>
                            <h4><a href=""></a></h4>
                            <p id="title">Lavage et repassage (À sec)</p>
                            <p>Délai de livraison: 24h-48h</p>
                            <div class="product-bottom-details">
        ...
        <table>
            ...
            <tr class="product">
                <th><div class="product-card">
                        <div class="badg">Homme</div>
                        <div class="product-tumb">
                            <img src="assets/img/produit/homme/VesteH.jpg" alt="">
                        </div>
                        <div class="product-details">
                            <span class="product-catagory"> Veste H</span>
                            <h4><a href="#"></a></h4>
                            <p id="title">Lavage et repassage (À sec) </p>
                            <p>Délai de livraison: 24h-48h</p>
                            <div class="product-bottom-details">
